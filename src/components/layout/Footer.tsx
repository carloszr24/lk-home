    ...
    <footer className="mt-24 border-t border-stone-200 bg-stone-50 text-stone-600">
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <h4 className="text-brand-charcoal text-xs tracking-widest uppercase mb-4">Navegación</h4>
            <ul className="space-y-2 text-sm">
              <li><Link href="/propiedades" className="transition-colors hover:text-brand-charcoal">Propiedades</Link></li>
              <li><Link href="/sobre-nosotros" className="transition-colors hover:text-brand-charcoal">Servicios</Link></li>
              <li><Link href="/contacto" className="transition-colors hover:text-brand-charcoal">Contacto</Link></li>
              <li><Link href="/aviso-legal" className="transition-colors hover:text-brand-charcoal">Aviso legal</Link></li>
              <li><Link href="/politica-privacidad" className="transition-colors hover:text-brand-charcoal">Privacidad</Link></li>
              <li><Link href="/politica-cookies" className="transition-colors hover:text-brand-charcoal">Cookies</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="text-brand-charcoal text-xs tracking-widest uppercase mb-4">Contacto</h4>
            <ul className="space-y-3 text-sm">
              ...
              <li className="pt-2">
                <p className="text-stone-400 text-xs mb-0.5">{OFFICES.primary.label}</p>
